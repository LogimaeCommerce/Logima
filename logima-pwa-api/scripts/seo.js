...
program
  ...
  .action(async (cmd) => {
    ...
    console.log('** The urls will be mapped to the new VS Url format. Please make sure You have "products.useMagentoUrlKeys=true" in Your logima-pwa/config/local.json')
