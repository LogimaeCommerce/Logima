...
<script>
import { ProductGallery } from '@logima-pwa/core/modules/catalog/components/ProductGallery.ts'
...
const ProductGalleryCarousel = () => import(/* webpackChunkName: "logima-product-gallery-carousel" */ './ProductGalleryCarousel.vue')
