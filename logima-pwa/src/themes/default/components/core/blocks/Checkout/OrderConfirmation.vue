...
<script>
import { ConfirmOrders } from '@logima-pwa/core/modules/offline-order/components/ConfirmOrders'
import { CancelOrders } from '@logima-pwa/core/modules/offline-order/components/CancelOrders'
