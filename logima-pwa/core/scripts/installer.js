...
const STOREFRONT_GIT_URL = 'https://github.com/LogimaeCommerce/logima-pwa'
const STOREFRONT_BACKEND_GIT_URL = 'https://github.com/LogimaeCommerce/logima-pwa-api'
...
const VUE_STOREFRONT_LOG_FILE = `${STOREFRONT_DIRECTORY}/var/log/logima-pwa.log`
const VUE_STOREFRONT_BACKEND_LOG_FILE = `${STOREFRONT_DIRECTORY}/var/log/logima-pwa-api.log`
...
class Manager extends Abstract {
  ...
  static checkUserOS () {
    if (isWindows()) {
      Message.error([
        ...
        'To install logima-pwa on your mac please go threw manual installation process provided in documentation:',
  ...
  static showWelcomeMessage () {
    Message.greeting([
      'Hi, welcome to the logima-pwa installation.',
...
let questions = [
  ...
  },
  {
    ...
    default: 'm076n7s9u9fto67ki9ejhgw5rdfxmk0k',
    when: function (answers) {
      return answers.m2_api_oauth2 === true
    }
  },
  {
    ...
    default: 'u7vyhw29n5ltc4wqv3hri5x6ojyo05oj',
    when: function (answers) {
      return answers.m2_api_oauth2 === true
    }
  },
  {
    ...
    default: 'tyfmsujl06ylb7ik09tbc2obgizuwcvb',
    when: function (answers) {
      return answers.m2_api_oauth2 === true
    }
  },
  {
    ...
    default: '1ee5qj02kieayvuyz88apqmbds0sy52d',
    when: function (answers) {
      return answers.m2_api_oauth2 === true
    }
  }
