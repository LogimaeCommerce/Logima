...
import AccountIcon from '@logima-pwa/core/compatibility/components/blocks/Header/AccountIcon'
    ...
    notify (title) {
      if (title === 'My loyalty card' || title === 'My product reviews') {
        this.$store.dispatch('notification/spawnNotification', {
          type: 'warning',
          message: this.$t('This feature is not implemented yet! Please take a look at https://github.com/LogimaeCommerce/logima-pwa/issues for our Roadmap!'),
