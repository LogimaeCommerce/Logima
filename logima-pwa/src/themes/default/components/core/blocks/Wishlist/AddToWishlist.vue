...
<script>
import { IsOnWishlist } from '@logima-pwa/core/modules/wishlist/components/IsOnWishlist'
import { AddToWishlist } from '@logima-pwa/core/modules/wishlist/components/AddToWishlist'
import { RemoveFromWishlist } from '@logima-pwa/core/modules/wishlist/components/RemoveFromWishlist'
