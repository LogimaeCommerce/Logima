...
import { breadCrumbRoutes, productThumbnailPath, isServer } from '@logima-pwa/core/helpers'
...
import { entityKeyName } from '@logima-pwa/core/store/lib/entities'
import { optionLabel } from '../../helpers/optionLabel'
import { quickSearchByQuery, isOnline } from '@logima-pwa/core/lib/search'
...
import { TaskQueue } from '@logima-pwa/core/lib/sync'
...
const actions: ActionTree<ProductState, RootState> = {
  ...
  /**
   * This is fix for https://github.com/LogimaeCommerce/logima-pwa/issues/508
