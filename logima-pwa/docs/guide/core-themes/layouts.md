...
Templates paths are relative to the root folder of `logima-pwa`. You can also set the template to none (`""`) to skip it. This option can be useful for XML / JSON / widgets rendering that does not require the whole HTML layout.
