...
- [Extending and overriding Vue Storefront modules](#extending-and-overriding-logima-pwa-modules)
...
The purpose is well described in [this discussion](https://github.com/LogimaeCommerce/logima-pwa/issues/1213). It can be sumamrized to:
...
See code [here](https://github.com/LogimaeCommerce/logima-pwa/blob/develop/core/modules/index.ts)
...
You can take a look at [module template](https://github.com/LogimaeCommerce/logima-pwa/tree/master/core/modules/module-template) with example implementation of all features listed in config.
...
All modules including the core ones are registered in `theme/modules/index.ts` file. Thanks to this approach you can easly modify any of core modules object before registration (read more [here](#extending-and-overriding-logima-pwa-modules)).
...
Try to choose method basing on use case. [This](https://github.com/LogimaeCommerce/logima-pwa/blob/develop/core/modules/mailchimp/components/Subscribe.ts#L28) is a good example of using callbacks.

5. Create pure functions that can be easly called with different argument. Rely on `data` properties instead of arguments only if it's required (for example they are validated like [here](https://github.com/LogimaeCommerce/logima-pwa/blob/develop/core/modules/mailchimp/components/Subscribe.ts#L28).
6. Document exported components like in example: https://github.com/LogimaeCommerce/logima-pwa/blob/develop/core/modules/mailchimp/components/Subscribe.ts
