...
const Home = () => import(/* webpackChunkName: "logima-home" */ 'theme/pages/Home.vue')
const PageNotFound = () => import(/* webpackChunkName: "logima-not-found" */ 'theme/pages/PageNotFound.vue')
const ErrorPage = () => import(/* webpackChunkName: "logima-error" */ 'theme/pages/Error.vue')
const Product = () => import(/* webpackChunkName: "logima-product" */ 'theme/pages/Product.vue')
const Category = () => import(/* webpackChunkName: "logima-category" */ 'theme/pages/Category.vue')
const CmsPage = () => import(/* webpackChunkName: "logima-cms" */ 'theme/pages/CmsPage.vue')
const CmsBlockDemoPageSsr = () => import(/* webpackChunkName: "logima-cms-demo" */ 'theme/pages/CmsBlockDemoPageSsr.vue')
const Checkout = () => import(/* webpackChunkName: "logima-checkout" */ 'theme/pages/Checkout.vue')
const Compare = () => import(/* webpackChunkName: "logima-compare" */ 'theme/pages/Compare.vue')
const MyAccount = () => import(/* webpackChunkName: "logima-my-account" */ 'theme/pages/MyAccount.vue')
const Static = () => import(/* webpackChunkName: "logima-static" */ 'theme/pages/Static.vue')
const CustomCmsPage = () => import(/* webpackChunkName: "logima-custom-cms" */ 'theme/pages/CustomCmsPage.vue')
const CmsData = () => import(/* webpackChunkName: "logima-data" */ 'src/modules/magento-2-cms/components/CmsData')
