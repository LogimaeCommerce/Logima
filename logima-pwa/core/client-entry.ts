...
import { createApp } from '@logima-pwa/core/app'
import EventBus from '@logima-pwa/core/compatibility/plugins/event-bus/index'
import rootStore from '@logima-pwa/core/store'

import buildTimeConfig from 'config'
import { execute } from '@logima-pwa/core/lib/sync/task'
import UniversalStorage from '@logima-pwa/core/store/lib/storage'
import i18n from '@logima-pwa/i18n'
import { prepareStoreView, storeCodeFromRoute, currentStoreView, localizedRoute } from '@logima-pwa/core/lib/multistore'
import { onNetworkStatusChange } from '@logima-pwa/core/modules/offline-order/helpers/onNetworkStatusChange'
import '@logima-pwa/core/service-worker/registration' // register the service worker
