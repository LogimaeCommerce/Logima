...
import { getSearchAdapter } from '@logima-pwa/core/lib/search/adapter/searchAdapterFactory'
import { processESResponseType } from '@logima-pwa/core/lib/search/adapter/graphql/processor/processType'
