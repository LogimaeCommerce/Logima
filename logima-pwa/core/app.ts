...
import { registerTheme } from '@logima-pwa/core/lib/themes'
import { themeEntry } from 'theme/index.js'
import { registerModules } from '@logima-pwa/core/lib/module'
import { prepareStoreView } from '@logima-pwa/core/lib/multistore'

import * as coreMixins from '@logima-pwa/core/mixins'
import * as coreFilters from '@logima-pwa/core/filters'
import * as corePlugins from '@logima-pwa/core/compatibility/plugins'

import { once } from '@logima-pwa/core/helpers'
import { takeOverConsole } from '@logima-pwa/core/helpers/log'
import store from '@logima-pwa/core/store'

import { enabledModules } from './modules-entry'

// Will be deprecated in 1.8
import { registerExtensions } from '@logima-pwa/core/compatibility/lib/extensions'
