...
Core component doesn't have CSS styles. If you want to see an example of our implementation please look [here](https://github.com/LogimaeCommerce/logima-pwa/blob/master/src/themes/default/components/core/Modal.vue)
