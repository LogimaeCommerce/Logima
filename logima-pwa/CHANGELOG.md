...
- New reactive helper to check online state. Usage: `import { onlineHelper } from '@logima-pwa/core/helpers'` and then `onlineHelper.isOnline` - @patzick (#2510)
...
### Deprecated / Removed
- `@logima-pwa/store` package deprecated - @filrak
...
## [1.8.0] - 2019.02.07
Additional migration tips are available [here](https://github.com/LogimaeCommerce/logima-pwa/blob/master/docs/guide/upgrade-notes/README.md).
...
### Removed
- `logima-payment-stripe` module integration removed from core

### Changed
- There is new config option `config.orders.directBackendSync` that changes the behavior of placing an order. Please do read  [more on this change](https://github.com/LogimaeCommerce/logima-pwa/commit/e73f2ca19a5d33a39f8b0fd6346543eced24167e) and [more on logima-pwa-api change](https://github.com/LogimaeCommerce/logima-pwa-api/commit/80c497f72362c72983db4fdcac14c8ba6f8729a8)
...
### Changed
- New Modules API, and base modules (cart, wishlist, newsletter ...) refactored [read more...](https://github.com/LogimaeCommerce/logima-pwa/blob/master/doc/api-modules/about-modules.md) - Filip Rakowski @filrak
...
### Changed
- Please check the [Upgrade notes](https://github.com/LogimaeCommerce/logima-pwa/blob/develop/doc/Upgrade%20notes.md) for the full list
...
### Added
- TypeScript support - please check [TypeScript Action Plan](https://github.com/LogimaeCommerce/logima-pwa/blob/master/docs/guide/basics/typescript.md) for details
- New `core/modules` added regarding the [Refactor to modules plan](https://github.com/LogimaeCommerce/logima-pwa/blob/master/doc/api-modules/refactoring-to-modules.md)
...
### Changed
- `core` directory is now a `@logima-pwa/core` package, webpack alias and all related imports reflect this change [#1513]
- `core/api` renamed to `core/modules`, mixin features moved to `core/modules/module_name/features`
- `core/lib/i18n` moved into separate `@logima-pwa/i18n` package
...
Please keep an eye on the **[UPGRADE NOTES](https://github.com/LogimaeCommerce/logima-pwa/blob/master/doc/Upgrade%20notes.md)**
...
- Page loader [#1240]
- Production ready Docker config for logima-pwa-api
...
## [1.0.2] - 2018-06-02
### Fixed
- logima-pwa-stripe renamed to logima-payment-stripe hotfix
- Minor fixes
