...
Then you may extend the [`logima-pwa-api`](https://github.com/LogimaeCommerce/logima-pwa-api) to add your custom API methods. Please take a look at: [mailchimp-subscribe](https://github.com/LogimaeCommerce/logima-pwa-api/blob/master/src/api/extensions/mailchimp-subscribe/index.js) for reference.
