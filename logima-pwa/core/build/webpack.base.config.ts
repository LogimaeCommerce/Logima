...
const translationPreprocessor = require('@logima-pwa/i18n/scripts/translation.preprocessor.js')
translationPreprocessor([
  path.resolve(__dirname, '../../node_modules/@logima-pwa/i18n/resource/i18n/'),
...
export default {
  ...
  resolve: {
    ...
    alias: {
      ...
      // Backward compatible
      '@logima-pwa/core/store/lib/multistore' : path.resolve(__dirname, '../lib/multistore.ts'),
    }
  },
  module: {
    rules: [
      ...
      },
      {
        ...
        loader: 'babel-loader',
        include: [
          path.resolve(__dirname, '../../node_modules/@logima-pwa'),
