...
<a href="https://travis-ci.org/LogimaeCommerce/logima-pwa"><img src="https://travis-ci.org/LogimaeCommerce/logima-pwa.svg?branch=master" alt="build:passed"></a>
...
Vue Storefront is a standalone PWA storefront for your eCommerce, possible to connect with any eCommerce backend (eg. Magento, <a href="https://github.com/LogimaeCommerce/coreshop-vsbridge">Pimcore/CoreShop</a>, [BigCommerce](https://github.com/LogimaeCommerce/bigcommerce2vuestorefront), Prestashop or Shopware) through the API.
...
**Important note to developers:** From 1.0RC we started using [develop](https://github.com/LogimaeCommerce/logima-pwa/tree/develop) branch for nightly builds (contains all new features) and [master](https://github.com/LogimaeCommerce/logima-pwa/tree/master) branch for stable. Please make sure you're working on right branch. Please take a look at [Contributing guidelines](https://github.com/LogimaeCommerce/logima-pwa/blob/master/CONTRIBUTING.md).
...
See the ideas behind Vue Storefront [here](https://www.slideshare.net/FilipRakowski/logima-pwa-basics)

**Read [contribution rules](https://github.com/LogimaeCommerce/logima-pwa/blob/master/CONTRIBUTING.md) before making any pull request. Pull request that doesn't meet these requirements will not be merged**
...
- [Read on how to integrate it with Magento2](https://medium.com/@piotrkarwatka/logima-pwa-how-to-install-and-integrate-with-magento2-227767dd65b2), [Read how to create Vue Storefront theme](https://medium.com/@frakowski/developing-themes-in-logima-pwa-backend-agnostic-ecommerce-pwa-frontend-part-1-72ea3c939593),
- [Read the interviews with authors of first production deployments](https://medium.com/@piotrkarwatka/logima-pwa-on-production-interview-with-gogetgold-com-developers-71e4b48ef996)

## Is it production ready?

Yes! There are more than 10 implementations happening right now and many live shops (check [awesome Vue Storefront list](https://github.com/frqnck/awesome-logima-pwa)).
...
[Here](https://github.com/LogimaeCommerce/logima-pwa/milestones) you can find the accepted roadmap for current milestone and what you can expect with next release.

#### Roadmap planning
[Here](https://github.com/LogimaeCommerce/logima-pwa/projects/3) you can vote for feature requests and see which ones were accepted. The most upvoted ones will be added to the next milestones. You can also join the slack channel `#roadmap-planning` where we discuss the next milestones.
...
[Check the feature list of 1.0](https://divanteltd.github.io/logima-pwa/guide/basics/feature-list.html).
...
**Please find out what we've already managed to prepare:** [available on Github Pages](https://divanteltd.github.io/logima-pwa/). Please note that new docs are still Work In Progress and will be successfully updated. You can find them also under the `docs` folder.
...
- [Installing on Linux/MacOS](https://divanteltd.github.io/logima-pwa/guide/installation/linux-mac.html)
- [Installing on Windows](https://divanteltd.github.io/logima-pwa/guide/installation/windows.html)
- [How to install and integrate with Magento2](https://divanteltd.github.io/logima-pwa/guide/installation/magento.html)
- [Production setup](https://divanteltd.github.io/logima-pwa/guide/installation/production-setup.html)

### Basics

- [Project structure](https://divanteltd.github.io/logima-pwa/guide/basics/project-structure.html) - good for introduction (outdated, we are working on interactive explorer :) )
- [Configuration file explained](https://divanteltd.github.io/logima-pwa/guide/basics/configuration.html)
- [Vue Storefront Modules](https://divanteltd.github.io/logima-pwa/guide/modules/introduction.html)
- [Contribution and issue reporting guideness](https://divanteltd.github.io/logima-pwa/guide/basics/contributing.html)
- [FAQ / Receipes](https://divanteltd.github.io/logima-pwa/guide/basics/recipes.html#problem-starting-docker-while-installing-the-logima-pwa)
- [Feature list](https://divanteltd.github.io/logima-pwa/guide/basics/feature-list.html)
- [TypeScript Action Plan](https://divanteltd.github.io/logima-pwa/guide/basics/typescript.html)
- [GraphQL Action Plan](https://divanteltd.github.io/logima-pwa/guide/basics/graphql.html)
- [SSR Cache](https://divanteltd.github.io/logima-pwa/guide/basics/ssr-cache.html)
- [Google Accelerated Mobile Pages](https://divanteltd.github.io/logima-pwa/guide/basics/amp.html)

### Vue Storefront core and themes

- [Working with themes](https://divanteltd.github.io/logima-pwa/guide/core-themes/themes.html)
- [Layouts and advanced output operations](https://divanteltd.github.io/logima-pwa/guide/core-themes/layouts.html)
- [Working with Vue Storefront core components](https://divanteltd.github.io/logima-pwa/guide/core-themes/core-components.html)
- [Working with UI Store (interface state)](https://divanteltd.github.io/logima-pwa/guide/core-themes/ui-store.html)
- [Working with translations](https://divanteltd.github.io/logima-pwa/guide/core-themes/translations.html)
- [Working with Service Workers](https://divanteltd.github.io/logima-pwa/guide/core-themes/service-workers.html)
- [Working with Webpack](https://divanteltd.github.io/logima-pwa/guide/core-themes/webpack.html)
- [Working with plugins](https://divanteltd.github.io/logima-pwa/guide/core-themes/plugins.html)

Tutorial series on creating themes for Vue Storefront:

- [Creating themes in Vue Storefront (part 1 — understanding Vue Storefront core)](https://medium.com/@frakowski/developing-themes-in-logima-pwa-backend-agnostic-ecommerce-pwa-frontend-part-1-72ea3c939593)

### Data in Vue Storefront

- [Working with data](https://divanteltd.github.io/logima-pwa/guide/data/data.html#local-data-store)
- [Working with Vuex](https://divanteltd.github.io/logima-pwa/guide/vuex/introduction.html)
- [ElasticSearch data formats](https://divanteltd.github.io/logima-pwa/guide/data/elasticsearch.html)
- [Data Migrations for ElasticSearch](https://divanteltd.github.io/logima-pwa/guide/data/data-migrations.html)
- [ElasticSearch Queries](https://divanteltd.github.io/logima-pwa/guide/data/elastic-queries.html)
- [Database tool](https://divanteltd.github.io/logima-pwa/guide/data/database-tool.html)
- [Adding Custom Entity Types](https://divanteltd.github.io/logima-pwa/guide/data/entity-types.html)

### Integrations

- [Vue Storefront + Magento](https://github.com/LogimaeCommerce/mage2vuestorefront)
- [Vue Storefront + Magento 1.9](https://github.com/LogimaeCommerce/magento1-vsbridge), [Magento 1.9 native indexer](https://github.com/LogimaeCommerce/magento1-vsbridge-indexer)
- [Vue Storefront + with Magento checkout](https://github.com/Vendic/magento2-external-checkout)
- [Vue Storefront + BigCommerce](https://github.com/LogimaeCommerce/bigcommerce2vuestorefront)
- [Vue Storefront + WooCommerce](https://github.com/LogimaeCommerce/woocommerce2vuestorefront)
- [Vue Storefront + Pimcore](https://github.com/LogimaeCommerce/coreshop-vsbridge)
- [Magento2 Product Reviews](https://divanteltd.github.io/logima-pwa/guide/integrations/reviews.html)
- [PayPal Payments integration](https://divanteltd.github.io/logima-pwa/guide/integrations/paypal-payments.html)
- [Direct prices sync with Magento](https://divanteltd.github.io/logima-pwa/guide/integrations/direct-prices-sync.html)
- [Tier prices sync with Magento](https://divanteltd.github.io/logima-pwa/guide/integrations/tier-prices-sync.html)
- [Shopping carts, totals and orders sync](https://divanteltd.github.io/logima-pwa/guide/integrations/totals-sync.html)
...
- [Magento2 MultiStore support](https://divanteltd.github.io/logima-pwa/guide/integrations/multistore.html)

### 'Default theme' contribution rules

- [Working with stylesheets (CSS)](https://divanteltd.github.io/logima-pwa/guide/core-themes/stylesheets.html)

## Awesome projects related to Vue Storefront

Check [Vue Storefront Awesome](https://github.com/frqnck/awesome-logima-pwa)
...
## Other platforms
Vue Storefront is platform agnostic which means it can be connected to virtually any CMS. Please take a look at [Pimcore bridge](https://github.com/LogimaeCommerce/coreshop-vsbridge) to give you an idea of how other platforms can be connected. Any support for integrating Prestashop, Shopify ... - much appreciated.

## The license

Vue Storefront source code is completely free and released under the [MIT License](https://github.com/LogimaeCommerce/logima-pwa/blob/master/LICENSE).

## Contributing

If you like the idea behind Vue Storefront and want to become a contributor - do not hesitate and check our [list of the active issues](https://github.com/LogimaeCommerce/logima-pwa/issues) or contact us directly via contributors@vuestorefront.io.
...
<table>
  ...
  <td align="center" valign="middle">
        ...
        <td align="center" valign="middle">
        <a href="https://bemeir.com/logima-pwa">
          <img
